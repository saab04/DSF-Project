  ...
  return (
    <div className="flex justify-center items-center inset-0 fixed bg-white/30 backdrop-blur-sm z-10">
      {loading ? (
        ...
        <div className="w-[85vw] sm:max-w-90 flex flex-col min-h-60 bg-foreground rounded-[20px] shadow-xl text-textPrimary fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          <div className="flex-1 flex flex-wrap justify-center items-center gap-3 p-4">
            <button
